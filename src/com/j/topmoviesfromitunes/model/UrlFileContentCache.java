 ...
 *
 */
public class UrlFileContentCache {

	/**
	 * Tag for logging
	 */
	private static final String TAG = UrlFileContentCache.class.getSimpleName();

	/**
	 * Singleton instance
	 */
	private static UrlFileContentCache instance = null;
	
	/**
	 * Singleton constructor
	 */
	private UrlFileContentCache() {}
	
	/**
	 * Get model instance
	 * @return Singleton model instance
	 */
	public synchronized static UrlFileContentCache getInstance() {
		//lazy instantiation
		//if no instance has been created
		if (null == instance) {
			//create new cache instance
			instance = new UrlFileContentCache();
		}
		//
	...
	public synchronized String get(Context context, URL key) {
			...
			SharedPreferences prefs = context.getSharedPreferences(UrlFileContentCache.class.getName() + "-Cache", Context.MODE_PRIVATE);
			//get cached value
