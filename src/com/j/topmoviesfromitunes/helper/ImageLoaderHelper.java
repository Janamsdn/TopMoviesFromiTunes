...
import com.j.topmoviesfromitunes.model.BitmapMemoryCache;
import com.j.topmoviesfromitunes.model.UrlFileContentCache;
 ...
 *
 */
public class ImageLoaderHelper extends AsyncTask<Object, Void, Bitmap> {
	...
	public ImageLoaderHelper(ImageView imageView, ProgressBar progressBar, URL imageUrl, int width, int height) {
	...
	protected Bitmap doInBackground(Object... params) {
		...
		//get cached bitmap
		cachedBitmap = bitmapMemoryCache.get(imageUrl.toString());
		...
		//get cache instance
		UrlFileContentCache cache = UrlFileContentCache.getInstance();
    	...
    	try {
	        ...
	        cachedBitmap = BitmapOperationHelper.loadScaledBitmap(imageView.getContext(), cachedFilePath, width, height);
	        //put bitmap in bitmap cache
	        bitmapMemoryCache.put(imageUrl.toString(), cachedBitmap);
	        //return bitmap
	        return cachedBitmap;
    	} catch (Exception e) {
